...
## Purpose
Single entrypoint for important Markdown files in this repository.
...
- `experiments-local/registry/README.md`
- `experiments-local/registry/INDEX.md`
- `experiments-local/registry/TEMPLATE_RUN_TRACE.md`
- `experiments-local/philo_assumption_challenge_2026-02-25/README.md`
- `experiments-local/philo_assumption_challenge_2026-02-25/DECISION_READY_REPORT_2026-02-26.md`
...
- `experiments-local/_review/ARCHIVE_CANDIDATES.md`

## Notes
If a file is missing from this index and is important for current work, add it here in the same change that creates/updates it.
